...
class master_control:
    ...
    def __init__(self):
        ...
        self.wheels_publish = rospy.Publisher("pi_police/wheels_speed",Vector3Stamped, queue_size=10)
        self.pid_publish = rospy.Publisher("pi_police/pid_start", Bool, queue_size=10)
        self.sd_sub = rospy.Subscriber("reply_pol", Float32, self.callback0)
        self.angles_sub = rospy.Subscriber("pi_police/imu_angles",Vector3Stamped, self.callback1)
        self.pid_sub = rospy.Subscriber("pi_police/control_effort", Float64, self.callback2)
        self.disp = rospy.Subscriber("dispatch_pol", Bool, self.callback3)
        self.blind = rospy.Subscriber("pi_police/blind", Bool, self.callback4)
        self.cam_pub = rospy.Publisher("pi_police/camera", Bool, queue_size = 10)
        #NEW
        self.req_pub = rospy.Publisher("pi_request_pol", Bool, queue_size = 10)
        self.junction = rospy.Subscriber("pi_police/junction", Bool, self.callback5)
